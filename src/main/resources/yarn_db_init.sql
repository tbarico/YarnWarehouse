...
-- Full database is not yet in use. If desired, comment out appropriate lines 
-- and statements to create final database.
...
CREATE TABLE `item` (
  ...
  `category_name` enum('Yarn','Knitting Needles') NOT NULL,
